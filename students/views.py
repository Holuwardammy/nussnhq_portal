...
def register_student(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Force all public users to remain students
...
def is_executive(user):
    ...
    return student and student.is_executive()
...
def is_president(user):
    ...
    return student and student.is_president()
...
def approve_payment(request, payment_id):
    ...
    if not (
        student and (
            ...
            or
            student.executive_assignments.filter(
...
def create_event(request, event_id=None):
    ...
    if not is_president(request.user):
        ...
        messages.error(
            request,
            'Only the President can manage events.'
        )
            ...
            if emails:
                ...
                try:
                    ...
                    send_mail(
                        ...
                        message=(
                            f'A new event has been posted '
                            f'on the NUSSNHQ Portal.\n\n'

                            f'Event: {saved_event.title}\n'
